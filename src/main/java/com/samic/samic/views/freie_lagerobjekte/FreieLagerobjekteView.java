...
public class FreieLagerobjekteView extends VerticalLayout {
    ...
    public FreieLagerobjekteView(ServiceStorageObject storageObjectService, ServiceStorage storageService, AuthenticatedUser authenticatedUser, ServiceUser userService, ReservationForm reservationForm) {
    ...
    private void initUI() {
        ...
        grid.addColumn(StorageObject::getObjectTypeName).setHeader("Name").setAutoWidth(true).setFlexGrow(1);
        grid.addColumn(StorageObject::getRemark).setHeader("Anmerkung").setAutoWidth(true).setFlexGrow(2);
    ...
    private ComponentRenderer<StorageObjectDetailsForm, StorageObject> createStorageObjectDetailsRenderer() {
        return new ComponentRenderer<>(StorageObjectDetailsForm::new, StorageObjectDetailsForm::setStorageObject);
    }
