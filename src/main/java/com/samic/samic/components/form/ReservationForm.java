...
public class ReservationForm extends FormLayout {
    ...
    private final BeanValidationBinder<Reservation> reservationBinder = new BeanValidationBinder<>(Reservation.class);
    ...
    private void initBinder() {
        ...
        //reservationBinder.bind(reservedFor, reservation1 -> reservation.getCustomer().connectionNo(), (reservation, t) ->reservation.setCustomer(Customer.builder().connectionNo(t).build()));
    }
