...
public class CPEForm extends FormLayout {
  ...
  private void initBinder() {
    ...
    binderStorageObject.forField(type)
        .bind(so -> so.getObjectTypeName().getName(), (so, value) -> so.getObjectTypeName().setName(value));
  ...
  public void setCPEBeans(List<ObjectType> objectTypes, Producer producer, CPE cpe,
